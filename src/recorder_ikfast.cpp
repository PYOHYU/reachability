...
// IK using Trac-IK
        ...
        {   
            ...
            bool found_ik = kinematic_state->setFromIK(joint_model_group, pose_col[i], attempts, timeout);
            ...
            */
            kinematic_state->setJointGroupPositions(joint_model_group, joints_init);
        }
